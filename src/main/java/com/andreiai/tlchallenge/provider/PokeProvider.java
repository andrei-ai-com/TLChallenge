...
public class PokeProvider {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PokeProvider.class);
    ...
    public String getPokemonDescription(String pokemonName) {
        ...
        logger.info("Calling PokeAPI: {}", url);
        ...
        try {
            ...
            throw new PokemonNotFoundException(String.format("Pokemon %s not found, please try a valid name. Examples: [pikachu, raichu, mewtwo, charizard, bulbasaur]", pokemonName), e);
